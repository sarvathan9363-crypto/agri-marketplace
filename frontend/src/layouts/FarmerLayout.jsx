...
export default function FarmerLayout() {
  ...
  const farmerLinks = [
    ...
    { to: '/farmer/products/add', label: t('navigation.addProduct', { defaultValue: 'Add Product' }), icon: PlusCircle }, { to: '/farmer/orders', label: t('navigation.orders'), icon: ShoppingBag },
