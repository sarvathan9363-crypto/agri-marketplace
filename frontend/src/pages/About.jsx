    ...
    <div className="min-h-[calc(100vh-var(--app-header-height))] bg-[#fafcf8] py-16">
      <PageContainer>
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-[#00684a] font-extrabold text-xs tracking-widest uppercase font-display bg-[#00ed64]/20 px-3 py-1 rounded-full">{t('about.ourPurpose')}</span>
          <h1 className="text-3xl sm:text-5xl font-black text-[#001e2b] font-display mt-3">{t('about.aboutAgribazaar')}</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white rounded-3xl border border-[#e8eddb] p-8 lg:p-10 shadow-sm">
            <span className="text-[#00684a] font-extrabold text-xs tracking-widest uppercase font-display">{t('about.corePillar')}</span>
            <h2 className="text-2xl font-black text-[#001e2b] font-display mt-1 mb-4">{t('about.ourMission')}</h2>
          ...
          <div className="bg-[#001e2b] text-white rounded-3xl border border-emerald-900/40 p-8 lg:p-10 shadow-xl">
            <span className="text-[#00ed64] font-extrabold text-xs tracking-widest uppercase font-display">{t('about.futureready')}</span>
            <h2 className="text-2xl font-black text-white font-display mt-1 mb-4">{t('about.ourVision')}</h2>
